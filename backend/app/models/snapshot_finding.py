...
class SnapshotFinding(Base, UUIDMixin):
    ...
    ⚠️ IDENTITY IS CONTENT, NOT A ROW. `finding_key` is a hash of what the finding IS (its kind plus
    ...
    ⚠️ `snapshot_fingerprint` RECORDS WHICH SNAPSHOT PRODUCED IT — it is not the identity. A finding
