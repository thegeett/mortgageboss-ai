...
async def extract_drivers_license(
    ...
    call = await run_extraction_completion(
        ...
        log_label="drivers_license",
    )
    if call.text is None:
        return DriversLicenseExtractionResult.failed(call.failure_reason or "AI call failed")

    result = _parse_drivers_license_json(call.text)
    if result is None:
