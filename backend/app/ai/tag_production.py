...
2. apparent_category — WHAT the transaction is, from the description. Values:
   "payroll", "transfer_own" (a transfer between the borrower's own accounts),
   "gift", "loan_proceeds", "refund", "interest", "fee", "vendor" (an ordinary purchase /
   merchant), or "unknown". Pick the single best fit; "unknown" if none clearly applies.
