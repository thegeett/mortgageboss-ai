...
DOCUMENT_TYPE_INDICATORS: dict[str, str] = {
    ...
    "earnest_money_receipt": "a receipt, an escrow/agent ACKNOWLEDGMENT OF RECEIPT OF MONIES, or a canceled check evidencing the earnest-money deposit (and any due-diligence fee) on the purchase — a STANDALONE one-or-two-page signed acknowledgment that the INITIAL earnest money deposit was received IS this type. A FULL purchase contract is NOT this type even when it contains such an acknowledgment page and names the earnest money and due-diligence fee: if the document carries the offer terms (purchase price, closing/settlement date, contingencies, signatures of buyer AND seller), it is purchase_agreement",
    ...
    "title_commitment": "a title insurance commitment or BINDER (ALTA) listing vesting, liens, and exceptions to clear before closing — carrying a Schedule A (vesting/legal) and Schedule B (exceptions); it counts even when bundled with the title INVOICE and a Closing Protection Letter (CPL), and even when the invoice or CPL is the LEAD page — the presence of a Schedule A/B commitment is what decides it. A title vendor's bill with NO Schedule A/B attached is service_invoice, not this type",
