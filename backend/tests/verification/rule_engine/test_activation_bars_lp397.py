...
def test_the_sign_off_activated_as6() -> None:
    ...
    assert (
        ...
        == 55  # LP-495a +RE-1/DT-6 (ONE matcher, ADR-375) +LO-2  # LP-493 +PC-8  # LP-492 +PR-2/PR-3/PR-4/PR-5/PR-7  # LP-491 +TI-1/TI-2/TI-6  # LP-490a +CR-1/CR-4/CR-8 (ratify-pending)  # LP-488 +MI-1/MI-4/CO-1/AU-3  # LP-487 +IH-2/IH-7  # LP-486 +CR-12  # LP-485 +CL-1/CR-13/PR-6
