...
def test_active_set_is_base_plus_lp389() -> None:
    assert (
        ...
        == (
            ...
            "AS-4",
            # LP-498 — FR-3, whose evidence is a first-class typed field set on the purchase
            # contract. LP-551 added FR-5 beside it, the first rule that reads money OUT; FR-1/2/4/6
            # remain held (see registry).
            "FR-3",
            "FR-5",
